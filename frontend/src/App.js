...
class App extends Component {
    constructor(props) {
		...
		this.steps = [
			{name: 'Name and icons',     render: this.renderStepNames,      optional: false, checkers: [this.checkTitle, this.checkAdapterName, this.checkType, this.checkDescription, this.checkKeywords]},
	...
	renderStepProperties() {
		...
		return [
			...
			isAdapter && this.state.answers.startMode === 'schedule' ? [(<TextField
				...
				margin="normal"
			/>),
				(<Fab className={this.props.classes.buttonCRON} size="small" color="primary" onClick={() => this.setState({showCron: true})} aria-label="Edit CRON"><EditIcon /></Fab>
				]: null,
